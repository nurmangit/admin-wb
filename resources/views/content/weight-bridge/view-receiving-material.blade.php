          ...
          <div class="row">
            ...
            <div class="col-4">
              ...
              <div class="mb-3">
                ...
                <textarea disabled id="remark" class="form-control @error('remark') is-invalid @enderror" name="remark" rows='12' placeholder="Enter any remarks">{{$weight_bridge->remark}}
                </textarea>
                @error('remark')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
