...
class Role extends Model implements RoleContract
{
    ...
    public static function create(array $attributes = [])
    {
        ...
        $params = ['Character01' => $attributes['name'], 'ShortChar01' => $attributes['guard_name']];
    ...
    public static function findByName(string $name, ?string $guardName = null): RoleContract
    {
        ...
        $role = static::findByParam(['Character01' => $name, 'ShortChar01' => $guardName]);
    ...
    public static function findById(int|string $id, ?string $guardName = null): RoleContract
    {
        ...
        $role = static::findByParam([(new static())->getKeyName() => $id, 'ShortChar01' => $guardName]);
    ...
    public static function findOrCreate(string $name, ?string $guardName = null): RoleContract
    {
        ...
        if (! $role) {
            return static::query()->create(['Character01' => $name, 'ShortChar01' => $guardName] + (app(PermissionRegistrar::class)->teams ? [app(PermissionRegistrar::class)->teamsKey => getPermissionsTeamId()] : []));
        }
